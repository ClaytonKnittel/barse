...
mod tests {
  ...
  use crate::{
    error::BarseResult, str_hash::station_hash, temperature_reading::TemperatureReading,
  };
  ...
  fn simple_scanner_iter(buffer: &[u8]) -> impl Iterator<Item = (&str, u64, TemperatureReading)> {
